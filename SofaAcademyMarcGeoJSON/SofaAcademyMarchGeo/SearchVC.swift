...
//    let button1 = CustomButton1(backgroundColor: .systemBlue, mojTitle: "", frame: CGRect(x: 0, y: 0, width: 100, height: 100))
...
//        let viewModel = MyCustomButtonViewModel(title : "Custom", imageName: "")
    ...
    private func styleViews() {
        imageView.image = UIImage(named: "geomag")
    
        textField1.backgroundColor = .systemGreen
...
//         }
        ...
        imageView.snp.makeConstraints {
            ...
            $0.centerX.equalTo(view.snp.centerX).offset(50)
